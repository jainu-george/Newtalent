...
export default class NewCustModal extends Component {
    static displayName = NewCustModal.name; 
  ...
  render() {
    ...
    return (
      <Modal
        trigger={<Button onClick={this.handleOpen} className='ui primary button'>New Customer</Button>}
