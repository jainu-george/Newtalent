...
export default class EditCustModal extends Component {
    static displayName = EditCustModal.name; 

  state = { name: this.props.customer.name, address: this.props.customer.address, submittedName: '', submittedAddress: '', modalOpen: false, loading: false }
