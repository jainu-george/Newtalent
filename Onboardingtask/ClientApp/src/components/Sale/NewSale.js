...
export default class NewSale extends Component {
    static displayName = NewSale.name; 
  ...
  handleSubmit = (e) => {
    ...
    const result = fetch('https://localhost:44384/Sales/PostSales', {
      method: 'post',
  ...
  render() {
    ...
    return (
      <Modal
        trigger={<Button onClick={this.handleOpen} className='ui primary button'>New Sale</Button>}
